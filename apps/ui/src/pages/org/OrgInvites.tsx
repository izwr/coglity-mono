...
export function OrgInvites() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    setError(null);
    try {
      const res = await inviteService.create(org.organizationId, {
        email,
        projectId,
        projectRole: role,
      });
  ...
  return (
    <div className="page">
      <PageHead
        title={
          <>
            <em className="italic-teal">Invites</em>
          </>
        }
            ...
            <Select
              ...
              value={
                projectId
                  ? {
                      value: projectId,
                      label: projects.find((p) => p.id === projectId)?.name ?? '',
                    }
                  : null
              }
      ...
      {lastLink && (
        <div className="ts-card">
          ...
          <div className="ts-card-actions">
            <Button variant="ghost" onClick={() => navigator.clipboard.writeText(lastLink)}>
              Copy
            </Button>
                ...
                {invites.map((i) => (
                  <tr key={i.id}>
                    ...
                    <td style={{ textAlign: 'right' }}>
                      <Button variant="danger" size="sm" onClick={() => revoke(i.id)}>
                        Revoke
                      </Button>
                    </td>
                  </tr>

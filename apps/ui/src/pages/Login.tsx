      ...
      <section className="auth-editorial">
        ...
        <div>
          ...
          <p className="auth-lede" style={{ marginTop: 18 }}>
            Author test cases, run them against your voice and chat systems, and triage failures
            with AI‑assisted root cause. Everything a QA team needs for conversational AI in one
        ...
        <div className="auth-proofs">
          <div className="auth-proof">
            ...
            >
              <path
                d="M 0 28 L 12 24 L 25 20 L 38 22 L 52 16 L 65 18 L 78 12 L 92 10 L 100 14"
                fill="none"
                stroke="var(--teal)"
                strokeWidth="1.5"
                strokeLinecap="round"
              />
              <path
                d="M 0 28 L 12 24 L 25 20 L 38 22 L 52 16 L 65 18 L 78 12 L 92 10 L 100 14 L 100 36 L 0 36 Z"
                fill="var(--teal)"
                opacity="0.1"
              />
            </svg>
      ...
      <section className="auth-panel">
        <div className="auth-card">
          ...
          <h2 className="auth-heading">
            {mode === 'signin' ? (
              <>
                Welcome <em className="italic-teal">back</em>.
              </>
            ) : (
              <>
                Start a <em className="italic-teal">workspace</em>.
              </>
            )}
          </h2>
          ...
          <div className="auth-hint">
            <svg
              className="ico"
              style={{ width: 14, height: 14, flex: 'none', marginTop: 2, color: 'var(--teal)' }}
              viewBox="0 0 24 24"
            >
